  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-[#050508] py-12 px-4 overflow-hidden selection:bg-accent-violet/30 selection:text-white">
      ...
      <motion.div 
        ...
        className="absolute top-1/4 right-1/4 w-[450px] h-[450px] bg-gradient-to-tr from-accent-cyan/15 to-blue-500/5 rounded-full blur-[140px] pointer-events-none" 
      />
      <motion.div 
        animate={{
          x: [0, 40, -40, 0],
        ...
        className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-gradient-to-tr from-accent-violet/10 to-purple-600/5 rounded-full blur-[120px] pointer-events-none" 
      />
            ...
            <div className="group/field">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 text-sm bg-black/40 border border-white/[0.06] rounded-xl text-white placeholder-text-muted/40 focus:outline-none focus:border-accent-emerald focus:ring-1 focus:ring-accent-emerald/20 transition-all duration-300 font-medium"
